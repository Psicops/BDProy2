...
spool "Oracle_Migration_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_Oracle_Migration ...
DROP ROLE ROLE_Oracle_Migration ;
PROMPT Creating Role ROLE_Oracle_Migration ...
CREATE ROLE ROLE_Oracle_Migration ;

-- PROMPT Drop Proy2 user
-- drop user Proy2 cascade;
   
PROMPT Create user Proy2
CREATE USER Proy2 identified by &&Proy2_password DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM TO Proy2;
...
GRANT ALL ON utils TO ROLE_Oracle_Migration;
grant ALL on utils to Proy2 with grant option;

set define on
prompt connecting to Proy2
connect Proy2/&&Proy2_password;
set define off
...
PROMPT Creating Primary Key Constraint PK__Equipos__40F9A20784F38B0C on table Team ... 
ALTER TABLE Team
ADD CONSTRAINT PK__Equipos__40F9A20784F38B0C PRIMARY KEY
(
  codigo
)
ENABLE
...
GRANT ALL ON Team TO ROLE_Oracle_Migration;
-- DROP TABLE Conf CASCADE CONSTRAINTS;


PROMPT Creating Table Conf ...
CREATE TABLE Conf (
  nombre VARCHAR2(55 CHAR),
  codigo VARCHAR2(10 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Confeder__40F9A207EEE4D044 on table Conf ... 
ALTER TABLE Conf
ADD CONSTRAINT PK__Confeder__40F9A207EEE4D044 PRIMARY KEY
(
  codigo
)
ENABLE
...
GRANT ALL ON Conf TO ROLE_Oracle_Migration;
-- DROP TABLE Group_ CASCADE CONSTRAINTS;


PROMPT Creating Table Group_ ...
CREATE TABLE Group_ (
  Grupo VARCHAR2(1 CHAR) NOT NULL,
  Confederacion VARCHAR2(10 CHAR),
  Equipo VARCHAR2(3 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Grupos__737363B4B1DAAEAF on table Group_ ... 
ALTER TABLE Group_
ADD CONSTRAINT PK__Grupos__737363B4B1DAAEAF PRIMARY KEY
(
  Grupo,
  Equipo
)
...
GRANT ALL ON Group_ TO ROLE_Oracle_Migration;
...
PROMPT Creating Foreign Key Constraint FK__Grupos__Equipo__29572725 on table Team...
ALTER TABLE Group_
ADD CONSTRAINT FK__Grupos__Equipo__29572725 FOREIGN KEY
(
  Equipo
)
REFERENCES Team
...
PROMPT Creating Foreign Key Constraint FK__Grupos__Confeder__286302EC on table Conf...
ALTER TABLE Group_
ADD CONSTRAINT FK__Grupos__Confeder__286302EC FOREIGN KEY
(
  Confederacion
)
REFERENCES Conf
