...
spool "MigraProy2_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_MigraProy2 ...
DROP ROLE ROLE_MigraProy2 ;
PROMPT Creating Role ROLE_MigraProy2 ...
CREATE ROLE ROLE_MigraProy2 ;
...
GRANT ALL ON utils TO ROLE_MigraProy2;
...
GRANT ALL ON Team TO ROLE_MigraProy2;
...
GRANT ALL ON Conf TO ROLE_MigraProy2;
...
GRANT ALL ON Group_ TO ROLE_MigraProy2;
