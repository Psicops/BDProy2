...
spool reportallstatus_PROY2_&filename..log

PROMPT Object Status Report on PROY2 schema
select owner "schema Name", object_name "Object Name", object_type "Object Type", status "Status", timestamp "Created Date and Time" from all_objects where owner = 'PROY2';
spool off
COMMIT;
